...
const EmailDetailHeaderMobile: React.FC<EmailDetailHeaderProps> = ({ 
    ...
    return (
        <header className="bg-background p-2 flex items-center justify-between flex-shrink-0 border-b border-border space-x-2">
            <div className="flex items-center space-x-1">
                <button onClick={onBack} className={`h-10 w-10 flex items-center justify-center rounded-md text-muted-foreground hover:bg-accent`} title="Back to list"><i className="fa-solid fa-arrow-left w-5 h-5"></i></button>
            </div>
